...
# 正統12級系統 (from settings file)
LEVELS_12 = {
    '感氣': 1, '感氣期': 1, '感氣境': 1,
    '聚元': 2, '聚元期': 2, '聚元境': 2, '聚元圓滿': 2,
    '築基': 3, '築基期': 3, '築基境': 3, '築基圓滿': 3,
    '煉魂': 4, '煉魂期': 4, '煉魂境': 4, '煉魂圓滿': 4,
    '凝神': 5, '凝神期': 5, '凝神境': 5, '凝神圓滿': 5,
    '化物': 6, '化物期': 6, '化物境': 6, '化物圓滿': 6,
    '悟天': 7, '悟天期': 7, '悟天境': 7, '悟天圓滿': 7,
    '掌命': 8, '掌命期': 8, '掌命境': 8, '掌命圓滿': 8,
    '破虛': 9, '破虛期': 9, '破虛境': 9, '破虛圓滿': 9,
    '造界': 10, '造界期': 10, '造界境': 10, '造界圓滿': 10,
    '超脫': 11, '超脫期': 11, '超脫境': 11, '超脫圓滿': 11,
    '永恆': 12, '永恆期': 12, '永恆境': 12, '永恆圓滿': 12,
}
