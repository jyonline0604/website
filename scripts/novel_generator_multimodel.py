            ...
            try:
                with open(os.path.join(NOVEL_DIR, filename), 'r', encoding='utf-8') as f:
                    ...
                    if title_match:
                        ...
                        title = title.replace(" - 科技修真傳", "").strip()
...
def generate_unique_title(chapter_num, used_titles):
    ...
    title_options = [
        ...
        "量子網絡", "虛擬實境", "神經連結", "科技奇點", "量子網關",
        "數據彼岸", "靈芯觉醒", "火種通道", "火種之核", "觀察者低語",
        "破序者", "靈芯之主", "數據元神", "納米意識", "量子纏繞",
        "虛擬神國", "數據神格", "現實融合", "終極進化", "創世之力",
        "法則掌控", "時空主宰", "多元宇宙", "維度戰爭", "終極真相",
        "創世之謎", "命運抉擇", "永恆之道", "最終覺醒", "黎明前夕",
        "最終決戰", "新的紀元", "時空裂縫", "異世界", "科技與修真",
        "輪迴之謎", "黑市探險", "靈池傳承", "能量風暴", "靈芯共振",
        # 科技相關
        "量子晶片", "神經網絡", "虛擬世界", "數據傳輸", "AI覺醒",
        "數位意識", "雲端修真", "區塊鏈道", "元宇宙", "星際網絡",
        "光子計算", "超弦理論", "暗物質", "反能量", "時空褶皺",
        "宇宙弦", "多維空間", "平行自我", "意識投射", "靈魂下載",
        "數據永生", "虛擬人格", "AI靈魂", "機械意識", "數字靈魂",
        "量子意識", "神經量子", "意識量子", "心靈傳感", "靈感共鳴",
        # 動作/衝突
        "生死之戰", "真相大白", "新的征程", "星際戰爭", "宇宙和平",
        "暗流湧動", "陰謀初現", "危機四伏", "逆轉勝", "絕地反擊",
        "天劫降臨", "能量耗盡", "最後一搏", "奇蹟逆轉", "覺醒之力",
        # 其他
        "新的開始", "傳承使命", "時空守護者", "維度跳躍", "終極對決",
        "宗門大比", "秘境試煉", "功法傳承", "突破瓶頸", "宗門測試",
        "第一任務", "廢墟探索", "神秘遺跡", "上古靈芯", "末法廢土",
        "系統啟動", "數據修煉", "修煉初體驗", "靈芯覺醒", "數據修仙"
    ]
