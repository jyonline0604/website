...
class InvestmentCalculator {
    ...
    calculateCompoundInterest() {
        ...
        document.getElementById('total-contributions').textContent = this.formatCurrency(principal + contributions);
    ...
    calculateRiskAssessment() {
        ...
        // 確定風險等級
        let riskLevel, riskDescription, recommendedAllocation;
        
        if (riskScore >= 80) {
            riskLevel = '積極型';
            riskDescription = '您有較高的風險承受能力，適合追求高回報的投資策略';
            ...
            riskLevel = '成長型';
            riskDescription = '您有中等風險承受能力，適合平衡增長與穩定的投資策略';
            recommendedAllocation = {
                '股票': '50%',
                '債券': '35%',
                '現金': '10%',
            ...
            riskLevel = '平衡型';
            riskDescription = '您有中等風險承受能力，適合穩健增長的投資策略';
            recommendedAllocation = {
                '股票': '40%',
                '債券': '45%',
                '現金': '10%',
            ...
            riskLevel = '保守型';
            riskDescription = '您有較低的風險承受能力，適合保本為主的投資策略';
            recommendedAllocation = {
                '股票': '20%',
                '債券': '60%',
                '現金': '15%',
            ...
            riskLevel = '極度保守型';
            riskDescription = '您有很低的風險承受能力，適合完全保本的投資策略';
            recommendedAllocation = {
                '股票': '5%',
                '債券': '70%',
                '現金': '20%',
        ...
        // 更新推薦配置
        const allocationElement = document.getElementById('recommended-allocation');
        let allocationHtml = '<ul>';
        for (const [asset, percentage] of Object.entries(recommendedAllocation)) {
            allocationHtml += `<li><strong>${asset}:</strong> ${percentage}</li>`;
        }
        allocationHtml += '</ul>';
        allocationElement.innerHTML = allocationHtml;
